...
public class IncomeMonthlyTemp extends AnselBaseEntity {
	...
	public IncomeMonthlyTemp(long id, double income, double payout, double bizIncome, double carriageMoney,
