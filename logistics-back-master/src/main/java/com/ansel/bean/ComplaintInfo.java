...
@Table(name = ComplaintInfo.TABLE_NAME)
@DynamicUpdate
@ApiModel
public class ComplaintInfo extends AnselBaseEntity {
	
	public static final String TABLE_NAME = "t_complaint_info";
	...
	public ComplaintInfo(long id, String customer, String goodsBillCode, String appealContent, String appealDate,
