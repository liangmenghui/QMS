...
public class ApprovedFlowRecordController extends WebController {
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "bsType", value = "产品类型，11：产品过程审核，12：成品检验，21：供应商体系审核，22：供应商资格审核", required = true, dataType = "int", paramType="query",defaultValue=""),
	})
	@RequestMapping(value = "/add", method = RequestMethod.POST)
	public ApiResponseResult add(ApprovedFlowRecord approvedFlowRecord, int bsType) {
		try {
			return approvedFlowRecordService.add(approvedFlowRecord, bsType);
