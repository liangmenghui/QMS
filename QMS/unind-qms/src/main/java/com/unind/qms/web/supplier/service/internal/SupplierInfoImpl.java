...
//        }else{}
        ...
        sqlbf1.append(" SELECT a.*,to_char(b.bs_created_time,'yyyy-MM-dd') checktime,(select count(1) from t_approved_flow_record t where t.bs_supp_id = a.id) flow_count,");
        ...
        sqlbf1.append(" LEFT JOIN t_approved_flow_record b on b.bs_supp_id = a.id");
        sqlbf1.append(" LEFT JOIN t_approved_flow c on c.id = b.bs_flow_id");
