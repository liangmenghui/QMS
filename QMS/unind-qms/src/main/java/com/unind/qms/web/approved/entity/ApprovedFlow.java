...
public class ApprovedFlow extends BaseEntity {
     ...
     * 允许让步
     */
    @ApiModelProperty(name="bsCanYield",required=true,value="允许让步")
    @Column
    protected int bsCanYield;

    /**
     * 通过状态
     */
    @ApiModelProperty(name="bsApprovedStatus",required=true,value="通过状态")
    @Column
    protected int bsApprovedStatus;

    /**
     * 未通过状态
     */
    @ApiModelProperty(name="bsRejectStatus",required=true,value="未通过状态")
    @Column
    protected int bsRejectStatus;
    ...
    public int getBsCanYield() {
        return bsCanYield;
    }

    public void setBsCanYield(int bsCanYield) {
        this.bsCanYield = bsCanYield;
    }

    public int getBsApprovedStatus() {
        return bsApprovedStatus;
    }

    public void setBsApprovedStatus(int bsApprovedStatus) {
        this.bsApprovedStatus = bsApprovedStatus;
    }

    public int getBsRejectStatus() {
        return bsRejectStatus;
    }

    public void setBsRejectStatus(int bsRejectStatus) {
        this.bsRejectStatus = bsRejectStatus;
    }
