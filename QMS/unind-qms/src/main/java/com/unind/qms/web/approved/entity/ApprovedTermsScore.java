...
public class ApprovedTermsScore extends BaseEntity {
     ...
     * 审核项目记录ID
     */
    @ApiModelProperty(name="bsItemsRecoreId",required=true,value="审核项目记录ID")
    @NotNull
    @Column
    protected Long bsItemsRecoreId;
    ...
    public Long getBsItemsRecoreId() {
        return bsItemsRecoreId;
    }

    public void setBsItemsRecoreId(Long bsItemsRecoreId) {
        this.bsItemsRecoreId = bsItemsRecoreId;
    }
