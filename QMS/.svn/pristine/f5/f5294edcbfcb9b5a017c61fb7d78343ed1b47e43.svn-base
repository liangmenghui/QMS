...
public class SupplierInfoController extends WebController {
	...
	public ApiResponseResult completeRiskLevel(Long id, Long bsRecordId, Integer bsRiskLevelUser, String bsApprovedAdvice, Integer bsResult){
		try{
			return supplierInfoService.completeRiskLevel(id, bsRecordId, bsRiskLevelUser, bsApprovedAdvice, bsResult);
		}catch(BusinessException e){
			e.printStackTrace();
			return ApiResponseResult.failure(e.getMessage());
		}
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "bsSuppId", value = "供应商ID", dataType = "String", paramType = "query", defaultValue = "", required = true),
	...
	public ApiResponseResult changeSuppGradeAndStatus(Long bsSuppId, int bsResult, int bsGrade) {
		try {
			return supplierInfoService.changeSuppGradeAndStatus(bsSuppId,bsResult,bsGrade);
		} catch (BusinessException e) {
			return ApiResponseResult.failure(e.getMessage());
		}
	}
	 ...
	 * 供应商特批
	 */
	@ApiOperation(value="供应商特批", notes="供应商特批")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "bsSuppId", value = "供应商ID", dataType = "String", paramType = "query", defaultValue = "", required = true),
	})
	@CrossOrigin(origins = "*")
	@RequestMapping(value = "/doPecialCheckSupplier", method = RequestMethod.POST)
	public ApiResponseResult doPecialCheckSupplier(SpecialCheckSupplierInfo specialCheckSupplierInfo) {
		try {
			
			return supplierInfoService.doPecialCheckSupplier(specialCheckSupplierInfo);
		} catch (BusinessException e) {
			return ApiResponseResult.failure(e.getMessage());
		}
	}
