...
public class FeedbackInfo extends BaseEntity {
    ...
    protected Set<FeedbackInfoExtra> infoExtraSet;
    ...
    public Set<FeedbackInfoExtra> getInfoExtraSet() {
        return infoExtraSet;
    }

    public void setInfoExtraSet(Set<FeedbackInfoExtra> infoExtraSet) {
        this.infoExtraSet = infoExtraSet;
    }
