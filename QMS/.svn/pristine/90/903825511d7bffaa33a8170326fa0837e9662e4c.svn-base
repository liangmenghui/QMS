...
public class ProductRisk extends BaseEntity {
     ...
     * GRR有无改善措施 0：无，1：有
     */
    @ApiModelProperty(name="bsGrrImprove",value="GRR有无改善措施")
    @Column
    protected int bsGrrImprove;
     ...
     * PPM不良品(最近12个月)
     */
    @ApiModelProperty(name="bsPpmResult",value="PPM不良品(最近12个月)")
    @Column
    protected double bsPpmResult;

    /**
     * PPM检验数(最近12个月)
     */
    @ApiModelProperty(name="bsPpmNum",value="PPM检验数(最近12个月)")
    @Column
    protected double bsPpmNum;
    ...
    public int getBsGrrImprove() {
        return bsGrrImprove;
    }

    public void setBsGrrImprove(int bsGrrImprove) {
        this.bsGrrImprove = bsGrrImprove;
    }
    ...
    public double getBsPpmResult() {
        return bsPpmResult;
    }

    public void setBsPpmResult(double bsPpmResult) {
        this.bsPpmResult = bsPpmResult;
    }

    public double getBsPpmNum() {
        return bsPpmNum;
    }

    public void setBsPpmNum(double bsPpmNum) {
        this.bsPpmNum = bsPpmNum;
    }
