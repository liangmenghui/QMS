...
<script>
export default {
    props:['shipmentRecordId','canUpload','fileList'],
    ...
    methods: {   
		getData(){
			...
			if(this.fileList.length != null && this.fileList.length != undefined && this.fileList.length>0){
        ...
        handleRemove(file, fileList) {  
            ...
            this.api.shipmentRecordFile.delete(params).then((res)=>{   
        ...
        handleUpload (file) {
            ...
            formData.append("bsShipmentRecordId",this.shipmentRecordId);

            this.api.shipmentRecordFile.add(formData).then((res) => {
