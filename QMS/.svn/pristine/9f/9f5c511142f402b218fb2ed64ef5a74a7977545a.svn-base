...
//    @NotNull
     ...
     * 性能测试时间
     */
    @ApiModelProperty(name="bsTestDeviceFile",value="性能测试时间")
    @Column
    protected Long bsTestTimeFile;

    /**
     * 性能测试时间是否通过
     */
    @ApiModelProperty(name="bsIsTestTime",value="性能测试时间是否通过")
    @Column
    protected int bsIsTestTime;
    ...
    public int getBsInspectLevel() {
        return bsInspectLevel;
    }

    public void setBsInspectLevel(int bsInspectLevel) {
    ...
    public Long getBsTestTimeFile() {
        return bsTestTimeFile;
    }

    public void setBsTestTimeFile(Long bsTestTimeFile) {
        this.bsTestTimeFile = bsTestTimeFile;
    }
    ...
    public int getBsIsTestTime() {
        return bsIsTestTime;
    }

    public void setBsIsTestTime(int bsIsTestTime) {
        this.bsIsTestTime = bsIsTestTime;
    }
