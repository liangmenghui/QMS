...
export default {
  ...
  methods: {
    getData: function() {
      ...
      this.content.receipt = this.form.receipt;
      this.content.delivery = this.form.delivery;
      this.content.invoiceCode = this.form.invoiceCode;
      this.$emit("on-commit", this.content);
    } //getFormData
  }, //methods
  computed: {
    total() {
