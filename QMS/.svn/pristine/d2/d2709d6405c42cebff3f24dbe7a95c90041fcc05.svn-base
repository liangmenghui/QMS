<template>
    ...
    <Form :model="formItem" :label-width="80" style="text-align:center"  :ref="dialog.ruleForm" :rules="dialog.ruleForm" >
        ...
        <FormItem label="发送信息邮箱"  prop='bsUser'>
            <Row>
                <Col span="12" >
                 <Input v-model="formItem.bsSender" placeholder="请输入发送人邮件" ></Input>
                </Col>
           </Row>
        </FormItem> -->
        ...
        <FormItem label="启用状态"  prop='bsInternetAddress'>
            <Row>
                <Col span="12" >
    ...
    export default {
        ...
        data () {
            return {
                ...
                message: '新增',
                dict: {
                    bsState:[{value: 0, name:'启用'},{value: 1, name:'禁止'}]
                },
                formQuery:
                {
                    bsUser: '',
                ...
                datagrid: {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            key: 'bsState',
                            render: (h, params) => {
                                return h('span', this.dict.bsState[params.row.bsState].name);
                        }
                        },
                        // {
                        //     title: '送样人SMTP口令',
        ...
        methods:{
            getDate(){
                this.api.lab.labmail.getlist().then((res) => {
                    if(res.result) {
             ...
             delete:function(params){
                ...
                loading: true,
                onOk: () => {
                    this.api.lab.labmail.delete(params.row).then((res)=>{
                        if(res.result) {
                            this.getDate();
               ...
               add(){
                this.api.lab.labmail.save(this.formItem).then((res) =>{
                    if(res.result){
                        this.getDate();
               ...
               update(params){
                this.api.lab.labmail.update(this.formItem).then((res) =>{
                    if(res.result){
                        this.getDate();
               ...
               handleSubmit(){
                ...
                this.api.lab.labmail.getlist(this.formQuery).then((res) =>{
                    if(res.result) {
                ...
                this.formItem.bsUser="";
                this.formItem.bsInternetAddress="";
                this.formItem.bsSmtpHost="";
                this.formItem.bsSmtpPort="";
                this.formItem.bsSmtpPw="";
                this.formItem.bsState="";
                this.formItem.bsSender="";
                },
