            ...
            <Row>
                <i-col>
                    <Form class="query_area" ref="formQuery" :model="formQuery" inline>
                        <Form-item>
                            <Input v-model="formQuery.bsCode" placeholder="请输入商品编码" />
                        </Form-item>
                        <Form-item>
                            <Input v-model="formQuery.bsSegment1" placeholder="请输入金合联物料编码" />
                        </Form-item>
                        <Form-item>
                        ...
                        <i-col>
                            <Form :model="formItem" :label-width="80" style="text-align:center" :ref="dialog.ruleForm" :rules="dialog.ruleForm">
                                <FormItem label="商品编码" prop='bsCode'>
                                    <Row>
                                        <i-col span="15">
                                            <Input v-model="formItem.bsCode" placeholder="请输入商品编码" />
                                        </i-col>
                                    </Row>
                                </FormItem>
                                <FormItem label="商品名称" prop='bsName'>
                                    <Row>
                                        <i-col span="15">
                                            <Input v-model="formItem.bsName" placeholder="请输入商品名称" />
                                        </i-col>
                                    </Row>
                                </FormItem>
                                <FormItem label="金合联物料编码" prop='bsSegment1'>
                                    <Row>
                                        <i-col span="15">
                                            <Input v-model="formItem.bsSegment1" placeholder="请输入金合联物料编码" />
                                        </i-col>
                                    </Row>
                                </FormItem>
                                <FormItem label="金合联物料名称" prop='bsDescription'>
                                    <Row>
                                        <i-col span="15">
                                            <Input v-model="formItem.bsDescription" placeholder="请输入金合联物料名称" />
                                        </i-col>
                                    </Row>
                                </FormItem>
                            </Form>
