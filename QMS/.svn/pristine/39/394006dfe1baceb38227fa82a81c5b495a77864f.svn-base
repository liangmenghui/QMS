...
<script>
    export default {
        ...
        methods: {
            ...
            //&& this.row.bsName !="" && this.row.bsName!=undefined
                if(this.row.testx !="" && this.row.testx!=undefined){
                    this.api.lab.sampletesttime.save(this.row).then((res) =>{
                            if(res.result){
            ...
            deleteData(){
                ...
                loading: true,
                onOk: () => {
                    this.api.lab.sampletesttime.deleteData(this.row).then((res)=>{
                        if(res.result) {
            ...
            //查询测试项
            selectTestx(){
                this.api.lab.equipmenttime.selectTestx(this.formQuery).then((res)=> {
                     if(res.result){                   
            ...
            selectEableeBsName(){ 
                ...
                this.bsNameList=[];
                this.api.lab.equipment.selectEablee(this.formQuery).then((res) =>{
                    if(res.result){
            ...
            changeEqName(){
                ...
                this.api.lab.equipmenttime.selectTestTime(this.formQuery).then((res) =>{ 
                    if(res.result){
                        this.row.testTime=0;
