...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getGroupList(){
                //获取组列表
                this.api.admin.group.getlist({page:1,rows:20}).then((res) => {
            ...
            deleteGroup(groupid){
                this.api.admin.group.deleteGroup({id:groupid}).then((res)=>{
                    // //console.log(res)
                    if(res.result ==true){
                        this.getGroupList();
            ...
            okClick(groupModel){
                ...
                this.api.admin.group.addGroup(groupModel).then((res) => {
                    // //console.log(res);
                    if(res.result == true){
                        this.getGroupList();
                    }
