...
//    protected ApprovedItemsRecord approvedItemsRecord;
     ...
     * 负责人ID
     */
    @ApiModelProperty(name = "bsResponsibleId", value = "负责人ID")
    @Column
    protected Long bsResponsibleId;
    ...
    public Long getBsResponsibleId() {
        return bsResponsibleId;
    }

    public void setBsResponsibleId(Long bsResponsibleId) {
        this.bsResponsibleId = bsResponsibleId;
    }
