...
public class ApprovedItemsImpl extends BaseOprService implements ApprovedItemsService {
    ...
    @Transactional
    public ApiResponseResult add(ApprovedItems approvedItems, String termsStr) throws BusinessException {
...
//        }
    ...
    @Transactional
    public ApiResponseResult edit(ApprovedItems approvedItems,String termsStr) throws BusinessException {
...
//        }
        ...
        o.setBsScoreLine(approvedItems.getBsScoreLine());
