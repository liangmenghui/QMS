<template>
		...
		<Row :style="{marginBottom: '20px'}">
			<Card>
				<p slot="title">
               	...
               	<div slot="extra" style="display:none;">
 ...
 -->	
		...
		<div id="documentbody" style="height: 320px;">
            <el-row :gutter="10">
              <el-col :span="4">
            ...
            <el-col :span="16">              
                ...
                <el-tag class="ml15">{{$t('approved.InspectionStatus['+shipmentInspectData.bsIsPrInfo+']')}}</el-tag> 
            </el-col>
            </el-row>
            ...
            <el-col :span="16">             
                ...
                <el-tag class="ml15">{{$t('approved.InspectionStatus['+shipmentInspectData.bsIsPrComposition+']')}}</el-tag> 
            </el-col>
            </el-row>  
            ...
            <el-tag class="ml15">{{$t('approved.InspectionStatus['+shipmentInspectData.bsIsPerformance+']')}}</el-tag>
            </el-col>
            </el-row>					
           ...
           <el-tag class="ml15">{{$t('approved.InspectionStatus['+shipmentInspectData.bsIsTestDevice+']')}}</el-tag> 
            </el-col>
            </el-row>
            ...
            <el-tag class="ml15">{{$t('approved.InspectionStatus['+shipmentInspectData.bsIsTestTime+']')}}</el-tag> 
            </el-col>
            </el-row>
            ...
            <el-button type="success" plain size="small" v-if="shipmentInspectData.bsTestResultFile" @click="downloadFile(shipmentInspectData.bsTestResultFile)">
             ...
             <el-tag class="ml15"> {{$t('approved.InspectionStatus['+shipmentInspectData.bsIsTestResult+']')}}</el-tag> 
            </el-col>
            </el-row>
		</div>
			</Card>
...
-->
		<Row :style="{marginBottom: '20px'}">
 			<Card>
				...
				<div id="testbody">			
					<p style="font-size: 14px;">{{$t('approved.WhetherTheTestResultsAreAcceptable')}}:<el-tag size="small" class="Result">{{$t('approved.comfirmResult['+shipmentInspectData.bsInspectResult+']')}}</el-tag></p>
...
-->
        ...
        <!-- <Modal v-model="modal_dialog" :title="$t('approved.AddVerificationUser')" @on-ok="addConfirmination">
         ...
         <center style="margin-top:20px;">
             <el-button  size="medium" type="success" v-if="" @click="getexportExcel" style="padding: 7px 20px; width: 10%">
