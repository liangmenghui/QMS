    ...
    <form>
        <table class="formed" align="left" valign="left">
            ...
            <tr>
                ...
                <td colspan="4">
                    <nobr>
                    公司编号NO.:<input v-model='content.bsCompanyNo'>
                   </nobr> 
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <nobr>
                    起运港:<input style='width:90%' v-model='content.bsLoading'>
                    </nobr>
                </td>
                <td colspan="3">
                   <nobr>
                    目的港:<input style='width:92%' v-model='content.bsDestination'>
                    </nobr>
                </td>
                <td colspan="2">
                    <nobr>
                    Via:<input v-model='content.bsVia'>
                    </nobr>
                </td>
            </tr>
             <tr>
         ...
         <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <input v-model="content.bsQuantity">
                </td>
                <td colspan="2">
            ...
            <tr >
                ...
                <td colspan="2">
                    <textarea  v-model='content.bsGoodsTime' rows="2"> </textarea>
                </td>
            </tr>
            <tr>
                <td colspan="4">
               ...
               <td colspan="2">
                ...
                <td colspan="2">
                    <textarea  rows="2" v-model='content.bsGoodsT'> </textarea>
                    <br> <br> <br>
                </td>
            </tr>
            <tr >
                ...
                <tr>
                   ...
                   <td colspan="4">
                        <textarea rows="5" v-model='content.bsRemark'></textarea>
                    </td>
                    </td>
                </tr>
                 <tr >
            ...
            <tr>
                <td colspan="4">
                    <textarea rows="5" v-model='content.bsNotity'></textarea>
                </td>
               <td colspan="1">
                   联系人 ATTN:<input v-model='content.bsContact'>
                </td>
                <td colspan="1">
                   电话:<input v-model='content.bsTel'>
                </td>
                <td colspan="1">
                   传真:<input v-model='content.bsFax'>
                </td>
                <td colspan="1">
                    E-mail:<input v-model='content.bsEmail'>
                </td>
            </tr>
        </table>
    </Form>
