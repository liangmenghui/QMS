...
//    protected int bsStatus;
    ...
    @ApiModelProperty(name="approvedFlowRecordByProduct",hidden=true,value="成品检验审核流程记录")
    @ManyToOne
    @JoinColumn(name = "bsProductRecordId", insertable = false, updatable = false)
    @NotFound(action = NotFoundAction.IGNORE)
    protected ApprovedFlowRecord approvedFlowRecordByProduct;
    ...
    public ApprovedFlowRecord getApprovedFlowRecordByProduct() {
		return approvedFlowRecordByProduct;
	}

	public void setApprovedFlowRecordByProduct(ApprovedFlowRecord approvedFlowRecordByProduct) {
		this.approvedFlowRecordByProduct = approvedFlowRecordByProduct;
	}
