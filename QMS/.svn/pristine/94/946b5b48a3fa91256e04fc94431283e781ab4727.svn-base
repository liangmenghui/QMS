...
public class SampleRegular extends BaseEntity {
    ...
    public Float getBsUpLimit() {
        return bsUpLimit;
    }

    public void setBsUpLimit(Float bsUpLimit) {
        this.bsUpLimit = bsUpLimit;
    }

    public Float getBsLowLimit() {
        return bsLowLimit;
    }

    public void setBsLowLimit(Float bsLowLimit) {
