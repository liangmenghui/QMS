...
public class SampleRegularRecord extends BaseEntity {
    ...
    @Column(length = 500)
    protected Float bsMeasureResult;

    /**
     * 测量结果是否合格
     */
    @ApiModelProperty(name="bsIsResult",value="测量结果是否合格")
    @Column
    protected int bsIsResult;
    ...
    public Float getBsMeasureResult() {
        return bsMeasureResult;
    }

    public void setBsMeasureResult(Float bsMeasureResult) {
        this.bsMeasureResult = bsMeasureResult;
    }

    public int getBsIsResult() {
        return bsIsResult;
    }

    public void setBsIsResult(int bsIsResult) {
        this.bsIsResult = bsIsResult;
    }
