...
//	public List<ApprovedFlow> findByBsName(String bsName);
	...
	public List<ApprovedTermsScore> findByBsItemsRecordIdOrderByIdAsc(Long bsItemsRecordId);
    ...
    //返回当前项目记录的条款得分
    @Query(value = "select decode(count(*),0,'',sum(decode(a.bs_score,-1,0,-2,0,a.bs_score)))||'/'||(sum(decode(a.bs_score,-1,0,1))*5) as bsScoreNum from "+ApprovedTermsScore.TABLE_NAME+" a where a.bs_items_record_id = ?1",nativeQuery = true)
