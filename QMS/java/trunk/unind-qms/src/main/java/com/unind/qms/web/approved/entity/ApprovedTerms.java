...
public class ApprovedTerms extends BaseEntity {
     ...
     * 合格分数线
     */
    @ApiModelProperty(name="bsScoreLine",value="合格分数线")
    @Column
    protected int bsScoreLine;
    ...
    public int getBsScoreLine() {
        return bsScoreLine;
    }

    public void setBsScoreLine(int bsScoreLine) {
        this.bsScoreLine = bsScoreLine;
    }
