...
export const appRouter = [
    {
        ...
        children: [
            ...
            { path: 'fs/doc', component: resolve => require(['@/view/member/fs/doc/index'], resolve), name: 'FS_WKGL', title: '文控管理' },
            { path: 'fs/release', component: resolve => require(['@/view/member/fs/release/index'], resolve), name: 'FS_WDFB', title: '文档发布' },
            { path: 'fs/doc-folder', component: resolve => require(['@/view/member/fs/foldermng/index'], resolve), name: 'FS_DOC_FOLDER', title: '文控目录管理' },
            //编码规则维护
            ...
            //流程
            { path: 'workflow/myprocess', component: resolve => require(['@/view/member/workflow/todo/myprocess'], resolve), name: 'MY_PROCESS', title: '我发起的' },
            { path: 'workflow/todolist', component: resolve => require(['@/view/member/workflow/todo/index'], resolve), name: 'TODO_LIST', title: '我的待办' },
            { path: 'workflow/completionlist', component: resolve => require(['@/view/member/workflow/done/index'], resolve), name: 'COMPLETION_LIST', title: '已办列表' },
            { path: 'workflow/frame', component: resolve => require(['@/view/member/workflow/done/frame'], resolve), name: 'COMPLETION_LIST', title: '流程配置' },


            //日志
            { path: 'log/online', component: resolve => require(['@/view/member/online/index'], resolve), name: 'YHGL_ONLINE', title: '在线用户管理' },
            { path: 'log/userActions', component: resolve => require(['@/view/member/online/userActions'], resolve), name: 'YHCZRZ', title: '用户操作日志' },
            { path: 'log/sys_logs', component: resolve => require(['@/view/member/online/sys_logs'], resolve), name: 'XTRZJL', title: '系统日志记录' },
            ...
            { path: 'pmp/shipmentEdit', component: resolve => require(['@/view/member/pmp/mrp/shipmentEdit'], resolve), name: 'PMP_CGWT', title: '出柜微调' },
            ...
            { path: 'lab/addSample', component: resolve => require(['@/view/member/lab/sample/addSample'], resolve), name: 'LAB_XZYP', title: '新增样品' }
        ]
    },
    {
        path: '/hr',
        ...
        children: [
            { path: 'system/dept', component: resolve => require(['@/view/member/hr/system/dept'], resolve), name: 'dept', title: '部门结构' },
            { path: 'system/job', component: resolve => require(['@/view/member/hr/system/job'], resolve), name: 'job', title: '工作职务' },
            { path: 'system/position', component: resolve => require(['@/view/member/hr/system/position'], resolve), name: 'position', title: '职位信息' },
            { path: 'system/profession', component: resolve => require(['@/view/member/hr/system/profession'], resolve), name: 'profession', title: '职业信息' },
            { path: 'system/person', component: resolve => require(['@/view/member/hr/system/person'], resolve), name: 'person', title: '人员信息' },
        ]
    },
    {
        path: '/lmp',
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'approvedEHSTermsMg', name: 'approvedEHSTermsMg', title: '审核EHS条款管理', component: resolve => require(['@/views/qms/view/settings/ApprovedEHSTermsManagement'], resolve) },
            { path: 'todoItems', name: 'todoItems', title: '待办事项', component: resolve => require(['@/views/qms/view/settings/TodoItems'], resolve) },
            { path: 'excelTempManagement', name: 'excelTempManagement', title: 'Excel模板管理', component: resolve => require(['@/views/qms/view/settings/excelTempManagement'], resolve) },
            { path: 'InspectionLevel', name: 'InspectionLevel', title: '检验水平', component: resolve => require(['@/views/qms/view/settings/InspectionLevel'], resolve) },

            {
                ...
                children: [
                    ...
                    {
                        path: 'eHSManagement', name: 'eHSManagement', title: 'EHS审核', component: resolve => require(['@/views/qms/view/approved/ApprovedEHSRecordsList'], resolve),
                        children: [
                            { path: 'instructions', name: 'supplierInstructions', title: '风险管理系统说明', component: resolve => require(['@/views/qms/view/supplier/Instructions'], resolve) },
                        ]
                    },
                    {
                        path: 'addEHSApproved', name: 'addEHSApproved', title: 'EHS审核新增', component: resolve => require(['@/views/qms/view/approved/ApprovedEHSItemAdd'], resolve)
                    },
                    ...
                    { path: 'CustomerReview', name: 'CustomerReview', title: '客户审核', component: resolve => require(['@/views/qms/view/approved/CustomerReview'], resolve) },
            ...
            },
            {
                ...
                name: 'supplier1',
                title: '供应商特批',
                component: resolve => require(['@/views/qms/view/supplier/SupplierSpecialCheck'], resolve),
                children: [
                    { path: 'basicInfo1', name: 'supplierbasicInfo1', title: '基本信息', component: resolve => require(['@/views/qms/view/supplier/SupplierBasicInfo'], resolve) },
                    { path: 'advanceInfo1', name: 'supplieradvanceInfo1', title: '补充信息', component: resolve => require(['@/views/qms/view/supplier/SupplierAdvanceInfo'], resolve) },
                    {
                        path: 'riskManagement1', name: 'supplierriskManagement1', title: '风险管理', component: resolve => require(['@/views/qms/view/supplier/SupplierRiskManage'], resolve),
                        children: [
                            { path: 'inputInformation1', name: 'supplierinputInformation1', title: '信息录入', component: resolve => require(['@/views/qms/view/supplier/InputInformation'], resolve) },
                            { path: 'instructions1', name: 'supplierInstructions1', title: '风险管理系统说明', component: resolve => require(['@/views/qms/view/supplier/Instructions'], resolve) },
                        ]
                    },

                    { path: 'createApprovedRecord1', name: 'supplierCreateApprovedRecord1', title: '新建审核', component: resolve => require(['@/views/qms/view/approved/ApprovedRecordCreator'], resolve) },
                    { path: 'approvedRecordsList1', name: 'supplierApprovedRecordsList1', title: '审核记录', component: resolve => require(['@/views/qms/view/approved/ApprovedRecordsList'], resolve) },
                    {
                        path: 'approved1',
                        name: 'supplierapproved1',
                        title: '供应商审核',
                        component: resolve => require(['@/views/qms/view/approved/ApprovedFlowRecordDetails'], resolve),
                        children: [
                            { path: 'itemsRecordDetails1', name: 'supplieritemsRecordDetails1', title: '条款审核', component: resolve => require(['@/views/qms/view/approved/ApprovedItemRecordDetails'], resolve) },
                            { path: 'tutorial1', name: 'suppliertutorial1', title: '辅导资料', component: resolve => require(['@/views/qms/view/approved/ApprovedExtraReports'], resolve) },
                            { path: 'otherReports1', name: 'supplierotherReports1', title: '资料审核', component: resolve => require(['@/views/qms/view/approved/ApprovedExtraReports'], resolve) }/*,
                            { path: 'report', name: 'supplierpreApproved', title: '审核报告', component: resolve => require(['@/views/qms/view/approved/ApprovedReport'], resolve) },
                            { path: 'preApproved', name: 'supplierpreApproved', title: '初期评审', component: resolve => require(['@/views/qms/view/approved/ApprovedReport'], resolve) },*/
                        ]
                    },
            ...
            { path: 'productBill', name: 'productBill', title: '过程审核清单', component: resolve => require(['@/views/qms/view/product/ProductBill'], resolve) },
            { path: 'productCheckList', name: 'productCheckList', title: '成品检验审核清单', component: resolve => require(['@/views/qms/view/product/ProductCheckList'], resolve) },
            {
                path: 'feedback',
                name: 'feedback',
                title: '客诉列表',
                ...
                children: [
					{ path: 'report', name: 'feedbackreport', title: '编辑客诉', component: resolve => require(['@/views/qms/view/feedback/FeedbackReport'], resolve) },
            ...
            { path: 'riskPpmManagement', name: 'riskPpmManagement', title: 'PPM值录入', component: resolve => require(['@/views/qms/view/risk/riskPpmManagement'], resolve) },
            { path: 'riskProductManagement', name: 'riskProductManagement', title: '产品风险录入', component: resolve => require(['@/views/qms/view/risk/riskProductManagement'], resolve) },
            { path: 'riskSuppPmpManagement', name: 'riskSuppPmpManagement', title: '供应商PMP风险录入', component: resolve => require(['@/views/qms/view/risk/riskSuppPmpManagement'], resolve) },
            { path: 'riskSuppApprManagement', name: 'riskSuppApprManagement', title: '供应商审核结果风险录入', component: resolve => require(['@/views/qms/view/risk/riskSuppApprManagement'], resolve) },
        ]
    },
];
