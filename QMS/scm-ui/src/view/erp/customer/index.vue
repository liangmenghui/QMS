    ...
    <div>
            ...
            <i-col>
                <Form class="query_area" ref="formQuery" :model="formQuery" inline>
                    <Form-item prop="bsCode">
                        <Input type="text" v-model="formQuery.bsCode" placeholder="客户编码" />
                    </Form-item>
                    <Form-item prop="bsName">
                        <Input type="text" v-model="formQuery.bsName" placeholder="客户名称" />
                    </Form-item>
                    <Form-item v-if="true">
        ...
        <Modal v-model="dialog.modal_dialog" title="" @on-ok="ok" @on-cancel="cancel" width="800">
            <p>
                ...
                <Row>
                    <i-col span="12">
                    <Form-item label="客户编码" prop="bsCode">
                        <Input v-model="dialog.formItem.bsCode" placeholder="请输入"></Input>
                    </Form-item>
                    </i-col>
                    <i-col span="12">
                    <Form-item label="客户名称" prop="bsName">
                ...
                <Row>
                    <i-col span="24">
                    <Form-item label="国家地区" prop="bsRegion">
                        <Input v-model="dialog.formItem.bsRegion" placeholder="请输入"></Input>
                    </Form-item>
                    </i-col>
                </Row>
                <Row>
                    <i-col span="24">
                    <Form-item label="客户地址" prop="bsAddress">
                        <Input v-model="dialog.formItem.bsAddress" type="textarea" placeholder="请输入..."></Input>
                    </Form-item>
                    </i-col>
                </Row>
                </Form>
...
export default {
    ...
    methods: {
        ...
        showEditDialog(params) {
            this.dialog.modal_dialog = true;
            let r = params.row;
            this.dialog.formItem = {id:r.id,bsCode:r.bsCode, bsName:r.bsName, bsCustomerId:r.bsCustomerId, bsAddress:r.bsAddress,bsOrganizationId:r.bsOrganizationId,bsRegion:r.bsRegion};
        },
        ok () {
