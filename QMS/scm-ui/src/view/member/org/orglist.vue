...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getOrgList(){
                //获取用户列表
                this.api.admin.organization.getlist({page:1,rows:20}).then((res) => {
            ...
            deleteOrg(orgid){
                this.api.admin.organization.deleteOrg({id:orgid}).then((res)=>{
                    // //console.log(res)
                    if(res.result ==true){
                        this.getOrgList();
            ...
            okClick(orgModel){
                ...
                this.api.admin.organization.addOrganization(orgModel).then((res) => {
                    // //console.log(res);
                    if(res.result == true){
                        this.getOrgList();
                    }
