        ...
        <Row>
            <i-col>
                <Form class="query_area" ref="formQuery" :model="formQuery" inline>
                    <Form-item prop="bsCatelog">
                        <Input v-model="formQuery.bsCatelog" placeholder="所属目录" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.api.admin.customfieldvalue.getlist(this.formQuery).then((res) => {
        ...
        showEditDialog(params) {
            this.dialog.modal_dialog = true;
            let r = params.row;
            this.dialog.formItem = {id:r.id,bsCode:r.bsCode, bsComment:r.bsComment};
        },
        ok () {
