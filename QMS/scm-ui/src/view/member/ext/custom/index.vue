    ...
    data() {
        return {
            ...
            datagrid: {
                ...
                columns: [
                    {
                        title: this.$t('systemInfo.CustomizedCatalogue.property'),
                        key: 'bsCode',
                        align: 'center',
                        render: (h, params) => {
                            return h('Button', {
                    ...
                    {
                        title: this.$t('systemInfo.CustomizedCatalogue.extend'),
                        key: 'bsTable'
                    },
                    {
                        title: this.$t('systemInfo.CustomizedCatalogue.describe'),
                        key: 'bsComment'
                    },
                    {
                        title: this.$t('systemInfo.CustomizedCatalogue.action'),
                        key: 'action',
                        render: (h, params) => {
                            let ary = [];
