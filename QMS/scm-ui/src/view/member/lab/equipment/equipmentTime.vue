...
<script>
  import {mapState} from 'vuex'
    export default {
        created(){
            this.getData();
            this.api.lab.equipment.selectbsName(this.formItem).then((res) => {
        ...
        methods:{
            getData(){
                this.api.lab.equipmenttime.list().then((res) => {
                    if(res.result) {
        ...
        t(){
            ...
            this.api.lab.equipmenttime.add(this.formItem).then((res) =>{
        ...
        delete:function(params){
            this.$Modal.confirm({
                ...
                loading: true,
                onOk: () => {
                    this.api.lab.equipmenttime.delete(params.row).then((res)=>{
                        if(res.result) {
                            this.getData();
    ...
    update(){
        if(this.formItem.bsName==''||this.formItem.testx==''||this.formItem.bsPartNo==''){
                ...
                this.api.lab.equipmenttime.update(this.formItem).then((res) =>{
                    this.getData();
    ...
    handleSubmit(){
        ...
        this.api.lab.equipmenttime.list(this.formQuery).then((res) =>{
            if(res.result) {
