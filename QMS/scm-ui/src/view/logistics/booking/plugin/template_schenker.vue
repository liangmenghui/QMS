    ...
    <form>
        <table class="formed" align="left" valign="left">
            ...
            <tr >
                ...
                <td colspan="2">
                    <textarea rows="5" v-model='form.bsCustomerReference'></textarea>
                </td>
            </tr>
            <tr >
                <td colspan="1">
                ...
                <td colspan="2">
                    <textarea rows="2" v-model='form.bsDeparture'></textarea>
                    <textarea rows="3" v-model='form.bsVessel'></textarea>
                </td>
            </tr>
            <tr >
                <td colspan="1">
                ...
                <td colspan="3">
                    <textarea rows="5" v-model='form.bsNotifyPart'></textarea>
                </td>
                <td colspan="2">
                    <p>Shipping Line:</p>
                    <p>船公司: </p>
                ...
                <td colspan="2">
                    <textarea rows="5" v-model='form.bsShippingLine'></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
