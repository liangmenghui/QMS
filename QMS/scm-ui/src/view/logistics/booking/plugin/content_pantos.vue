        ...
        <table class="formed" align="left" valign="left">
           <tr style="width:70%">
               <td colspan="4" style="width:20%;">
                ...
                <td colspan="2" style="width:10%">
                    <textarea rows="2" v-model="content.bsSoNo"></textarea>
                </td>          
           </tr>
           <tr>
               <td colspan="4">
               ...
               <td colspan="1">
                ...
                <td colspan="2">
                   <textarea v-model="content.bsElNo" rows="2"></textarea>
                </td>
           </tr>
           <tr>
              <td colspan="2" style="border-bottom-style: solid;border-width:2px;border-color:#000">
                  <nobr>
                     PIC: <input v-model="content.bsShipperPic" style="width:92%">
                  </nobr>
              </td> 
              <td colspan="2" style="border-bottom-style: solid;border-width:2px;border-color:#000">
                  <nobr>
                    Tel :  <input v-model="content.bsShipperTel" style="width:92%">
                  </nobr>     
             </td> 
           ...
           <tr>
               <td colspan="4" style="border-bottom-style: solid;border-width:2px;border-color:#000">
                   <textarea v-model="content.bsConsignee" rows="5"></textarea>
               </td>
           ...
           <tr>
               <td colspan="4" >
                   <textarea  v-model="content.bsNotifyParty" rows="5"></textarea>
               </td>
               <td colspan="4" style="border-style:none none none solid">
                    <textarea v-model="content.bsShippingOrder" rows="5" ></textarea>
                </td>
           </tr>
           <tr>
               <td colspan="2">
           ...
           <tr>
                ...
                <td colspan="2">
                        <input  v-model="content.bsClosing">
                </td>
                <td colspan="1">
                  <p>ETA:</p>
                </td>
                <td colspan="1">
                     <input v-model="content.bsEta">
                </td>
            </tr>
            <tr>
               <td colspan="2">
           ...
           <tr>
                ...
                <td colspan="2">
                     <input v-model="content.bsRequired">
                </td>
            </tr>
            <tr>
            ...
            <tr align=center>
                ...
                <td colspan="1">
                      <input v-model="content.bsPackagesQuantity">
                </td>
                <td colspan="3">
