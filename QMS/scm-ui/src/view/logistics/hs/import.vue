        ...
        <div class="ivu-import-form">
          ...
          <Form :label-width="80" class="ivu-form-ctx">
            <Row :gutter="16">
              ...
              <i-col span="2">
                <Upload ref="upload" :action="upload.action" :before-upload="handleUploadBefore" :on-success='handleUploadSuccess' :on-error='handleUploadError' :on-format-error="handleFormatError" :format="upload.fileType" :accept="acceptype" :show-upload-list="false">
