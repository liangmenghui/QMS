<template>
  <div class="ivu-preplan">
    <Form ref="formQuery" :model="formQuery" :label-width=120 inline>
      <Row>
        <i-col span="12">
          <FormItem label="发货日期:">
            <Input v-model="formQuery.cdSendDate" placeholder="请输入发货日期" style="width:200px" />
          </FormItem>
        </i-col>
        <i-col span="12" class="btngroup">          
          <Button type="primary" @click="handleSubmit()">查 询</Button>
          <Button type="primary" @click="initModal">Booking</Button>
        </i-col>
      </Row>
    </Form>
    <Row>
