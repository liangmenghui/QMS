...
export default{
    ...
    getContextData(data){
        return httpservice.postdata('/lmp/booking/generate',data,false);
    },
    saveContent(data){
        return httpservice.postdata('/lmp/booking/save',data,false);
    },
    updateSO(data){
        return httpservice.get('/lmp/booking/updateSO',data);
    },
    download(data){
        return httpservice.download('/lmp/booking/download',data);
    }
}
