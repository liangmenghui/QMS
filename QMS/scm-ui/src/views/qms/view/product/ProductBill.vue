<template>
  	<div class="ProductList" v-if="!showRooterView" >
  		<Row style="margin-bottom: 10px;">
            ...
            <el-date-picker size="medium" style="width:150px;" v-model="formQuery.startDate" type="date" value-format="yyyy-MM-dd"></el-date-picker>
			<Icon type="shuffle" style="font-size: 16px"></Icon>
			<el-date-picker size="medium" style="width:150px;" v-model="formQuery.endDate" type="date" value-format="yyyy-MM-dd"></el-date-picker>
