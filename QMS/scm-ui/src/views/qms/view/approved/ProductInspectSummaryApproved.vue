<template>
	...
	<div class="productinspectsummaryapproved">
		<Row :style="{marginBottom: '20px'}">
			<center><h4 style="font-size: 16px;">{{$t('approved.SummaryOfShipmentInspectionReport')}}</h4></center>
		</Row>
		<Row :style="{marginBottom: '20px'}">
			<Card>
				<p slot="title">
               	...
               	<el-tag slot="extra" v-if="!perms.edit" color="white" style="font-size: 14px;margin-top: -5px;">
