	...
	<div class="upcbox">   
      ...
      <ul class="to-do-list-con" v-model="todolistdata">
        <li v-for="item in toDoList ">
            ...
            <el-col :span="4" align="center" v-if="item.bsType==12||item.bsType==13||item.bsType==23">
                <el-button  size="mini" type="primary" plain @click="closeItem(item.id)">{{$t('Dashboard.CloseTodo')}}</el-button>
            </el-col>
         </el-row>
       </li>          
     </ul>  		  
