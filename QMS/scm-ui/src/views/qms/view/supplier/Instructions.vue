...
export default {
    data() {
      	return {
      		...
      		{level:'2',instructions:'大于12个月，小于24个月无交货延迟',score:'6',note:''},
      		{level:'3',instructions:'大于3个月，小于12个月无交货延迟  ',score:'9',note:''},
      		...
      		{level:'2',instructions:'小于等于120天，大于90天',score:'2',note:''},
      		{level:'3',instructions:'小于等于90天，大于30天',score:'3',note:''},
      		{level:'4',instructions:'小于等于30天，大于15天',score:'4',note:''},
      		{level:'5',instructions:'小于等于15天或者现金',score:'5',note:''},
      		],
      		SPC:[
